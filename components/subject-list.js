            ...
            <div v-for="s in subjects" :key="s.id"
              ...
              <div class="absolute bottom-3 right-3 flex gap-1.5">
                ...
                <button @click.stop="$emit('importSubjectCSV', s)"
                  ...
                  <svg class="w-4 h-4 sm:w-3.5 sm:h-3.5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M3 16.5v2.25A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75V16.5m-13.5-9L12 3m0 0 4.5 4.5M12 3v13.5"/></svg>
                </button>
