            ...
            <div v-for="s in subjects" :key="s.id"
              ...
              <div class="absolute bottom-3 right-3 flex gap-1.5">
                <button @click.stop="$emit('exportCard', s)"
                        class="min-w-[36px] min-h-[36px] sm:min-w-[28px] sm:min-h-[28px] flex items-center justify-center rounded-lg bg-indigo-50 dark:bg-indigo-900/30 text-indigo-400 hover:text-indigo-600 hover:bg-indigo-100 dark:hover:bg-indigo-800/40 transition border border-indigo-200 dark:border-indigo-800/40"
                ...
                <button @click.stop="$emit('importSubjectJSON', s)"
                        class="min-w-[36px] min-h-[36px] sm:min-w-[28px] sm:min-h-[28px] flex items-center justify-center rounded-lg bg-emerald-50 dark:bg-emerald-900/30 text-emerald-400 hover:text-emerald-600 hover:bg-emerald-100 dark:hover:bg-emerald-800/40 transition border border-emerald-200 dark:border-emerald-800/40"
                ...
                <button @click.stop="$emit('deleteSubject', s)"
                        class="min-w-[36px] min-h-[36px] sm:min-w-[28px] sm:min-h-[28px] flex items-center justify-center rounded-lg bg-red-50 dark:bg-red-900/30 text-red-400 hover:text-red-600 hover:bg-red-100 dark:hover:bg-red-800/40 transition border border-red-200 dark:border-red-800/40"
                        :title="'Borrar ' + s.name">
