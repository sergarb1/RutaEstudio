(function() {
  ...
  GC.components['focus-mode-btn'] = {
    ...
    template: `
      <button v-if="show"
              @click="$emit('toggle')"
              class="fixed bottom-4 right-4 z-30 bg-indigo-600 text-white w-11 h-11 rounded-full shadow-lg hover:bg-indigo-700 transition flex items-center justify-center"
