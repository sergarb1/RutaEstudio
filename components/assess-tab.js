    ...
    template: `
      <div class="tab-fade-in bg-white dark:bg-slate-800 rounded-2xl p-5 border border-slate-200 dark:border-slate-700">
        <div class="flex items-center justify-between mb-4">
          ...
          <button @click="root.submitAssessment()" class="flex items-center gap-1.5 bg-green-600 text-white text-sm font-bold px-4 py-2.5 sm:py-2 min-h-[44px] sm:min-h-[36px] rounded-xl hover:bg-green-700 transition">
