  ...
  GC.components['subject-detail'] = {
    ...
    template: `
      <div class="fade-enter-active">
        <button @click="$emit('back')" class="text-sm text-indigo-600 dark:text-indigo-400 font-medium mb-4 flex items-center gap-1.5 min-h-[36px] hover:underline transition">
        ...
        <div class="flex items-start justify-between mb-4">
          ...
          <div class="flex gap-2">
            <button @click="$emit('export-json')" class="flex items-center gap-1.5 text-xs bg-white dark:bg-slate-800 border dark:border-slate-600 rounded-lg px-3 py-2 min-h-[44px] sm:min-h-[36px] font-medium transition hover:bg-slate-50 dark:hover:bg-slate-700" :title="GC.t('subject.export')">
            ...
            <button @click="$emit('edit-subject')" class="flex items-center gap-1.5 text-xs bg-white dark:bg-slate-800 border dark:border-slate-600 rounded-lg px-3 py-2 min-h-[44px] sm:min-h-[36px] font-medium transition hover:bg-slate-50 dark:hover:bg-slate-700">
        ...
        <div class="relative mb-4">
          <div class="flex gap-1 bg-white dark:bg-slate-800 rounded-xl p-1 border border-slate-200 dark:border-slate-700 text-sm font-medium overflow-x-auto tabs-scroll">
            <button @click="root.tab='concepts'"
                     ...
                     class="flex items-center gap-1.5 px-4 py-2 min-h-[44px] sm:min-h-[36px] rounded-lg transition flex-shrink-0">
